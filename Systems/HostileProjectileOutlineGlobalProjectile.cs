...
namespace CalamityLegendsReturn.Systems
{
    ...
    internal sealed class HostileProjectileOutlineGlobalProjectile : GlobalProjectile
    {
        ...
        public override bool PreDraw(Projectile projectile, ref Color lightColor)
        {
            ...
            int outlineWidth = CLCRClientConfig.Instance?.HostileProjectileOutlineWidth ?? 2;
        ...
        {
            return !Main.dedServ &&
                CLCRClientConfig.Instance != null &&
                CLCRClientConfig.Instance.ShowHostileProjectileOutlines &&
                projectile.active &&
                projectile.hostile &&
                !projectile.friendly &&
                !projectile.hide &&
