...
namespace CalamityLegendReturn.BossAI.HDMC
{
    ...
    public sealed class HDMCLaserHostile : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (age == ChargeTime)
            {
                if (!Main.dedServ)
                {
                    CLCRLightingBoltsSystem.Spawn_MatrixDataBurst(Projectile.Center, HDMCUtil.DataColor(0.35f), 0.6f);
    ...
    public sealed class HDMCFusionBlastHostile : ModProjectile
    {
        ...
        public override void OnSpawn(IEntitySource source)
        {
            ...
            CLCRLightingBoltsSystem.Spawn_MatrixDataBurst(Projectile.Center, fuseColor, 1.2f);
