    ...
    public sealed partial class HDMCSovereign : ModNPC
    {
        ...
        private void DoIntro(Player target)
        {
            ...
            if (Timer == 140 && !Main.dedServ)
            {
                ...
                CLCRLightingBoltsSystem.Spawn_MatrixGeometryShatter(NPC.Center, c);
                CLCRLightingBoltsSystem.Spawn_MatrixDataBurst(NPC.Center, c, 1.3f);
        ...
        private void DoTransition(Player target)
        {
            ...
            if (Timer == 60 && !Main.dedServ)
            {
                ...
                CLCRLightingBoltsSystem.Spawn_MatrixDataBurst(NPC.Center,
        ...
        public override void HitEffect(NPC.HitInfo hit)
        {
            ...
            if (NPC.life <= 0)
            {
                ...
                Color c = HDMCUtil.DataColor(Main.GlobalTimeWrappedHourly * 0.5f);
                CLCRLightingBoltsSystem.Spawn_MatrixSingularityCollapse(NPC.Center);
                CLCRLightingBoltsSystem.Spawn_MatrixGeometryShatter(NPC.Center, c);
                CLCRLightingBoltsSystem.Spawn_MatrixDataBurst(NPC.Center, c, 1.6f);
