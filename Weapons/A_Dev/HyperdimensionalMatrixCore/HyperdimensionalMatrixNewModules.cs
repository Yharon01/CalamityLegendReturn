...
namespace CalamityLegendReturn.Weapons.A_Dev.HyperdimensionalMatrixCore
{
    ...
    public sealed class MatrixMobiusRing : ModProjectile, ILocalizedModType
    {
        ...
        private void SpawnFireParticles()
        {
            ...
            CLCRLightingBoltsSystem.Spawn_MatrixDataBurst(center,
    ...
    public sealed class MatrixFractalTree : ModProjectile, ILocalizedModType
    {
        ...
        private void SpawnLeafParticles()
        {
            ...
            CLCRLightingBoltsSystem.Spawn_MatrixDataBurst(Projectile.Center,
    ...
    public sealed class MatrixPenroseTiling : ModProjectile, ILocalizedModType
    {
        ...
        private void SpawnCollapseParticles()
        {
            ...
            Color burstColor = HyperdimensionalMatrixVisuals.GetDataColor(Main.GlobalTimeWrappedHourly * 0.5f);
            CLCRLightingBoltsSystem.Spawn_MatrixSingularityCollapse(center);
            CLCRLightingBoltsSystem.Spawn_MatrixDataBurst(center, burstColor, 1.2f);
            CLCRLightingBoltsSystem.Spawn_MatrixGeometryShatter(center, burstColor);
    ...
    public sealed class MatrixParaboloidWarp : ModProjectile, ILocalizedModType
    {
        ...
        private void SpawnParticles()
        {
            ...
            CLCRLightingBoltsSystem.Spawn_MatrixDataBurst(center, HyperdimensionalMatrixVisuals.GetDataColor(0.2f), 0.6f);
        }
