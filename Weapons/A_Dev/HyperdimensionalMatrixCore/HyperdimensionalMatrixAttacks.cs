...
namespace CalamityLegendsReturn.Weapons.A_Dev.HyperdimensionalMatrixCore
{
    ...
    public sealed class MatrixDataGridPanel : ModProjectile, ILocalizedModType
    {
        ...
        private void SpawnCellFlashParticles()
        {
            ...
            CLCRLightingBoltsSystem.Spawn_MatrixDataBurst(
    ...
    public sealed class MatrixGeoBurst : ModProjectile, ILocalizedModType
    {
        ...
        private void SpawnExplosionParticles()
        {
            ...
            CLCRLightingBoltsSystem.Spawn_MatrixGeometryShatter(Projectile.Center, burstColor);
            CLCRLightingBoltsSystem.Spawn_GaussDischargeShards(Projectile.Center);
            CLCRLightingBoltsSystem.Spawn_MatrixDataBurst(Projectile.Center, burstColor, 0.7f);
        }
    ...
    public sealed class MatrixShaderOrb : ModProjectile, ILocalizedModType
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            if (OrbType == 3)
                CLCRLightingBoltsSystem.Spawn_MatrixSingularityCollapse(Projectile.Center);
            else
                CLCRLightingBoltsSystem.Spawn_MatrixDataBurst(Projectile.Center, GetOrbColor(), 0.78f);
    ...
    public sealed class MatrixFusionExplosion : ModProjectile, ILocalizedModType
    {
        ...
        public override void OnSpawn(IEntitySource source)
        {
            ...
            CLCRLightingBoltsSystem.Spawn_MatrixDataBurst(Projectile.Center, fuseColor, 1.4f);
            CLCRLightingBoltsSystem.Spawn_MatrixGeometryShatter(Projectile.Center, fuseColor);
    ...
    public sealed class MatrixSpaceWarpField : ModProjectile, ILocalizedModType
    {
        ...
        public override void OnKill(int timeLeft)
        {
            if (!Main.dedServ)
            {
                ...
                CLCRLightingBoltsSystem.Spawn_MatrixDataBurst(Projectile.Center, warpColor, 1f);
                CLCRLightingBoltsSystem.Spawn_GaussSingularityPulse(Projectile.Center);
        ...
        public override void AI()
        {
            ...
            if (age == Phase2Fire && Main.myPlayer == Projectile.owner && target != null)
            {
                ...
                if (!Main.dedServ && Main.LocalPlayer.active)
                {
                    ...
                    CLCRLightingBoltsSystem.Spawn_MatrixDataBurst(target.Center, stormColor, 1.2f);
                    CLCRLightingBoltsSystem.Spawn_MatrixGeometryShatter(target.Center, stormColor);
                }
            }
            ...
            if (age == Phase3Sing && Main.myPlayer == Projectile.owner && target != null)
            {
                ...
                if (!Main.dedServ && Main.LocalPlayer.active)
                {
                    ...
                    CLCRLightingBoltsSystem.Spawn_MatrixSingularityCollapse(target.Center);
                    CLCRLightingBoltsSystem.Spawn_GaussSingularityPulse(target.Center);
                }
            }
        }
    ...
    public sealed class MatrixRunicStamp : ModProjectile, ILocalizedModType
    {
        ...
        private void SpawnFireParticles()
        {
            ...
            CLCRLightingBoltsSystem.Spawn_MatrixGeometryShatter(Projectile.Center, burstColor);
            CLCRLightingBoltsSystem.Spawn_MatrixDataBurst(Projectile.Center, burstColor, 0.8f);
        }
